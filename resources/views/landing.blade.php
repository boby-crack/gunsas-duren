...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center gap-3">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#cara-gabung">Mitra Reseller</a></li>
                    ...
                    @if (Route::has('login'))
                                ...
                                <a class="nav-link dropdown-toggle btn btn-light rounded-pill px-4" href="#" role="button" data-bs-toggle="dropdown">
                                    ...
                                    @if(Auth::user()->role == 'reseller')
                                        ...
                                        @elseif(Auth::user()->status_akun == 'waiting_approval')
                                            <span class="badge bg-info ms-1">Menunggu Verifikasi</span>
                                        @endif
                                    @endif
                                </a>
                                <ul class="dropdown-menu shadow border-0">

                                    {{-- MENU BERDASARKAN STATUS --}}
                                        ...
                                        @if(Auth::user()->status_akun == 'active')
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="{{ route('catalog.index') }}">
                                                    <i class="fas fa-shopping-bag me-2 text-muted"></i> Belanja Produk
                                                </a>
                                            </li>
                                        @elseif(Auth::user()->status_akun == 'pending')
                                            {{-- BELUM UPLOAD KTP --}}
                                            <li>
                                                <a class="dropdown-item" href="{{ route('profile.complete.create') }}">
                                                    <i class="fas fa-file-upload me-2 text-danger"></i> Lengkapi Profil
                                                </a>
                                            </li>
                                        @elseif(Auth::user()->status_akun == 'waiting_approval')
                                            {{-- MENUNGGU ACC ADMIN --}}
                                            <li>
                                                <a class="dropdown-item" href="{{ route('verification.notice') }}">
                                                    <i class="fas fa-clock me-2 text-info"></i> Cek Status Verifikasi
                                                </a>
                                            </li>
                                        @endif
                                    @endif
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a href="{{ route('register') }}" class="btn btn-primary-custom">Daftar Reseller</a>
                            </li>
                        @endauth
                    @endif
                </ul>
    ...
    <section id="cara-gabung" class="py-5 bg-white">
        <div class="container text-center">
            <h2 class="fw-bold mb-5">Mudahnya Jadi Mitra Kami</h2>
            <div class="row justify-content-center">
                <div class="col-md-3 mb-4">
                    <div class="rounded-circle bg-warning text-white d-flex align-items-center justify-content-center mx-auto mb-3" style="width: 80px; height: 80px; font-size: 2rem;">
                        <i class="fas fa-user-plus"></i>
                    </div>
                    <h5 class="fw-bold">1. Daftar Akun</h5>
                    <p class="text-muted small">Isi data diri Anda untuk membuat akun reseller resmi.</p>
                </div>
                <div class="col-md-3 mb-4">
                    <div class="rounded-circle bg-warning text-white d-flex align-items-center justify-content-center mx-auto mb-3" style="width: 80px; height: 80px; font-size: 2rem;">
                        <i class="fas fa-shopping-basket"></i>
                    </div>
                    <h5 class="fw-bold">2. Pilih Produk</h5>
                    <p class="text-muted small">Login dan pesan produk durian premium sesuai kebutuhan stok Anda.</p>
                </div>
                <div class="col-md-3 mb-4">
                    <div class="rounded-circle bg-warning text-white d-flex align-items-center justify-content-center mx-auto mb-3" style="width: 80px; height: 80px; font-size: 2rem;">
                    ...
                    <p class="text-muted small">Bayar via transfer bank. Admin akan memverifikasi pesanan Anda.</p>
                </div>
                <div class="col-md-3 mb-4">
                    <div class="rounded-circle bg-warning text-white d-flex align-items-center justify-content-center mx-auto mb-3" style="width: 80px; height: 80px; font-size: 2rem;">
                        <i class="fas fa-store"></i>
                    </div>
                    <h5 class="fw-bold">4. Ambil di Cabang</h5>
                    <p class="text-muted small">Datang ke cabang pilihan pada tanggal pengambilan (H+3) dengan bukti invoice.</p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="card h-100 border-0 shadow-sm hover-top">
                        <div class="card-body text-center p-4">
                            ...
                            <div class="d-flex justify-content-between text-muted small">
                                ...
                                <a href="https://www.google.com/maps/search/?api=1&query={{ urlencode($toko->nama_toko . ' ' . $toko->kota) }}" target="_blank" class="text-warning text-decoration-none fw-bold">
                    ...
                    <div class="card border-0 shadow-sm p-3 h-100">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mt-3">
                                ...
                                <div>
                                    <h6 class="fw-bold mb-0">Pak Hendra</h6>
                                    <small class="text-muted">Reseller Jakarta Selatan</small>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mt-3">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">Reseller Bogor</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm p-3 h-100">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mt-3">
                                ...
                                <div>
                                    <h6 class="fw-bold mb-0">Mas Dimas</h6>
                                    <small class="text-muted">Reseller Depok</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                        <div class="accordion-body text-muted">
                            Ya, untuk mendapatkan harga khusus Reseller, minimal pembelian pertama adalah 5 Box. Pembelian selanjutnya bebas tanpa minimal order.
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo">
                            Kapan barang bisa diambil setelah pesan?
                        </button>
                    </h2>
                    <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body text-muted">
                            Sistem kami menerapkan H+3. Jika Anda memesan hari Senin, barang siap diambil hari Kamis. Ini untuk memastikan kualitas stok durian yang fresh.
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree">
                            Apakah bisa dikirim ke rumah?
                        </button>
                    </h2>
                    <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body text-muted">
                            Saat ini kami hanya melayani sistem <strong>Ambil di Cabang (Pickup)</strong> untuk menjaga kualitas beku produk dan menekan biaya ongkir Anda.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    ...
                    <p class="small text-secondary">
                        Penyedia durian kupas dan olahan durian premium nomor 1 di Indonesia.
                        Kami berkomitmen memberdayakan mitra reseller untuk sukses bersama.
                    </p>
                    <div class="d-flex gap-3">
